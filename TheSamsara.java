...
public class theSamsara {
	...
	public static void allenamentoSwain(Protagonista p)
	{
	    ...
	    System.out.println("La tua resistenza attuale Ë: " + p.getResistenza());
	...
	public static void shop()
	{
		...
		while(1>0)
		{
			...
			System.out.println("Basta cos√¨? [Y] Yes, [N] No");
			int r;
			do
			{
				r = Leggi.unChar();
	...
	{	
	    ...
	    System.out.println("Il tuo livello di forza attuale Ë: " + p.getForza());
